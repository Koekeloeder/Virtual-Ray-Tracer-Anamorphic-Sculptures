...
public class MeshDeformer : MonoBehaviour
{
    ...
    bool ValidateSetup()
    {
        ...
        if (eyeTransform == null)
        {
            ...
            if (mainCam != null)
            {
                eyeTransform = mainCam.transform;
                Debug.Log("Using Main Camera as eye");
            }
            else
            {
...
*/
    ...
    Vector3 TraceRefraction(Vector3 P, Vector3 N, Vector3 incident, Vector3 targetPoint)
    {
        ...
        float distance = Vector3.Distance(targetPoint, Pout);
        return Pout + Rout * distance;
    }
